...
**Version :** 14.0 — Simplification du bloc alimentation : un seul LM74610/MOSFET (pas de OR-ing, redondant avec le switch SOURCE) ; condensateur VCAP ajouté à l'Annexe A
**Date :** Juillet 2026
...
| Résistance shunt | ~0,05-0,1 Ω, traversant axial (1-2 W) (R5) | 1 | 6 | Mesure de courant (base des 3 comparateurs du canal) |
...
| Optocoupleur d'isolement | PC817, boîtier DIP-4 traversant (R5) | 1 | 6 | Isolement de la mesure côté VEHICLE (protection structurelle F5) |
| Comparateur quadruple LM339 | LM339N, boîtier DIP-14 traversant (R5) | 3/4 de puce | 5 puces au total* | Détection ouvert/court (2 seuils) + injection rapide (1 seuil) par canal |
...
| Transistor de commutation (pilotage DEL) | 2N7000, boîtier TO-92 traversant (R5) | 3 | 18 | Un par couleur (R/V/B), tout-ou-rien |
| Potentiomètre de calibration de seuil | Multi-tours, petit format | 1 | 6 | Ajustement ouvert/court selon le courant nominal réel du canal |

*Total comparateurs requis : 3 par canal × 6 canaux = 18, + 1 pour la masse (§A.4) = 19 → **5× LM339** (20 comparateurs disponibles, 1 de marge).
...
| Composant | Référence / modèle suggéré | Qté | Utilité |
|---|---|---|---|
| Driver bar/dot | LM3914N, boîtier DIP-18 traversant (R5) | 1 | Pilotage analogique de la jauge |
