...
> **Statut à l'ouverture de cette section :** le Canal_TAIL est maintenant **✅ validé et clos** (voir §7.2, mise à jour v22) — LEFT peut donc être répliqué à partir d'un modèle figé. Un point reste en suspens :
> 1. **Numérotation des références KiCad** — dernières références confirmées utilisées par TAIL : R1–R38 (les 38 comprennent le diviseur anti-oscillation R37/R38), D1–D26, Q1–Q12, U1–U3, F1–F2, SW1–SW3, OC1–OC2. La numérotation ci-dessous pour LEFT est une proposition provisoire à partir de ces bornes, à corriger une fois l'état réel du projet KiCad connu.
...
**Composants — sous-bloc VEHICLE (canal LEFT), proposition en attente de confirmation des références :**

| Rôle | Réf. proposée (provisoire) | Composant | Boîtier |
|---|---|---|---|
| Résistance de charge | R_LEFT (num. à confirmer) | ~2-3 Ω, 5 W | Traversant, `R_Axial_Power_L25.0mm_W9.0mm_P27.94mm` |
| Résistance shunt | RSH_LEFT | ~0,05-0,1 Ω, 5 W | Traversant, même footprint |
| Comparateur triple | U_LEFT (LM339) | Sections A/B/C = injection/ouvert/court | DIP-14, socket turned-pin (R7) |
| Isolement | OPTO_LEFT (PC817-2) | 2 canaux isolés (Ouvert/Court) | DIP-8 traversant |
| MOSFET injection | Q_LEFT_INJECT (IRLZ44N) | — | TO-220 |
| Potentiomètres de calibration | POT_LEFT ×3 | Seuils injection/ouvert/court (Option B, indépendants) | Traversant, multi-tours |
| Pull-ups sorties comparateur | R ×3, 4,7 kΩ | — | Traversant |
| Limitatrices DEL (opto) | R ×2, 1 kΩ | — | Traversant |

*(Sous-blocs TRAILER_LEFT et Bloc_Test_Left à détailler une fois VEHICLE_LEFT confirmé, par symétrie avec §7.2.3/§7.2.4.)*
