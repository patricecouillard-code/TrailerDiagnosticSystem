...
### 10.1 Checklist de revalidation par canal (composants dimensionnés empiriquement — R8)
...
|---|---|---|---|
| RL_x (résistance de charge, côté VEHICLE) | Valeur selon charge DEL/incandescente réelle du canal | ⏳ En attente | ⏳ En attente |
| RSH_x (shunt, côté VEHICLE) | P = I²×R avec courant nominal mesuré + marge | ⏳ En attente | ⏳ En attente |
| RSH2_x (shunt, côté TRAILER) | P = I²×R avec courant nominal mesuré + marge | ⏳ En attente (R34 conservée provisoirement à ~0,05-0,1 Ω / 1-2 W, §7.2.3) | ⏳ En attente |
| PTC_x (polyfuse) | Calibre courant de maintien vs courant nominal + marge | ⏳ En attente | ⏳ En attente |
| TVS_x | Tenue en tension vs transitoires attendues (véhicule/remorque) | ⏳ En attente | ⏳ En attente |
